<section class="wp-block-cegos-cegos-page-section page-section page-section__container">
    <div class="Block-chiffres">
        ...
        <div class="stats">
            <div class="stat">
                <img src="/images/client.jpg" alt="icone client" class="stat_img">
                <p class="stat_nbr">20 000</p>
                <p class="stat_para">Lorem, ipsum dolor.</p>
            </div>
            <div class="stat stat--blue">
                <img src="/images/world.png" alt="icone de la plannette terre" class="stat_img">
                <p class="stat_nbr">50</p>
                <p class="stat_para">pays</p>
            </div>
            <div class="stat">
                <img src="/images/flag.png" alt="icon de drapau" class="stat_img">
                <p class="stat_nbr">300</p>
                <p class="stat_para">lorem</p>
            </div>
            <div class="stat stat--blue">
                <img src="/images/client.jpg" alt="icone client" class="stat_img">
                <p class="stat_nbr">20 000</p>
