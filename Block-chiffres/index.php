    ...
    <div class="Block-chiffres">
        ...
        <div class="Block-chiffres_stats">
            <div class="Block-chiffres_stat">
                <img src="/images/client.jpg" alt="icone client" class="Block-chiffres_stat_img">
            ...
            <div class="Block-chiffres_stat Block-chiffres_stat--blue">
                <img src="/images/world.png" alt="icone de la plannette terre" class="Block-chiffres_stat_img">
                <p class="Block-chiffres_stat_nbr">50</p>
                <p class="Block-chiffres_stat_para">pays</p>
            </div>
            <div class="Block-chiffres_stat">
                <img src="/images/flag.png" alt="icon de drapau" class="Block-chiffres_stat_img">
